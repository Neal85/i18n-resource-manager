...
(function() {
  ...
  ResourceManager = (function() {
    ResourceManager.prototype.RESOURCE_KEY = "__localization_manager";
    ...
    function ResourceManager(options) {
      ...
      if (global[this.RESOURCE_KEY] === void 0 || global[this.RESOURCE_KEY][this.indexKey] === void 0) {
    ...
    ResourceManager.prototype.get = function() {
      var filePath, i, item, key, prefix, _i, _len, _ref;
      key = "";
      prefix = "";
    ...
    ResourceManager.prototype.buildIndexKey = function(options) {
      return this.resourceUtils.resolveKey(options.key);
    };

    ResourceManager.prototype.reBuild = function() {
      var resource, rulesCache;
      rulesCache = this.resourceUtils.buildRules(this.options);
      resource = global[this.RESOURCE_KEY] = {};
      return resource[this.indexKey] = rulesCache;
    };
  ...
  ResourceUtils = (function() {
    ...
    ResourceUtils.prototype.propertyFileToJSON = function(fileData) {
      var c, i, key, keyArr, line, lineArr, result, subKey, symbolIndex, value, _i, _j, _len, _len1;
      result = {};
