...
(function() {
  var ResourceManager, ResourceOptions, ResourceType, configOptions, configResource, cssOptions, envOptions, envResource, fs, htmlResource, nOptions, nResource, options, path, propertiesOptions, propertiesResource, styleResource, _ref, _ref1, _ref2;
  ...
  propertiesOptions.rules = ['_default/_default/_default', '_default/_default/{country}', '_default/{lang}/_default', '_default/{lang}/{country}', '{platform}/_default/_default', '{platform}/_default/{country}', '{platform}/{lang}/_default', '{platform}/{lang}/{country}', '_default/{subPlatform}/_default/_default', '_default/{subPlatform}/_default/{country}', '_default/{subPlatform}/{lang}/_default', '_default/{subPlatform}/{lang}/{country}'];
